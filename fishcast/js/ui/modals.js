            ...
            <div class="modal-content" onclick="event.stopPropagation()">
                ...
                <div style="padding: 20px;">
                    ...
                    <div style="margin: 15px 0; padding: 15px; background: var(--bg-primary); border-radius: 8px;">
                        ...
                        <div style="font-size: 0.9rem; color: var(--text-secondary); margin-bottom: 10px;">Choose a look: light, dark, Largemouth Bass, Crappie, SBA (clean monochrome), or Bluegill.</div>
